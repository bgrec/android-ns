...
class NetworkOrdersRepository(
    ...
    /**
     * Updates the [MastroAndroidApiService] instance used by this repository.
     *
     * This method allows updating the [MastroAndroidApiService] instance to use a new instance
     * provided as [newMastroAndroidApiService]. This is typically used for dependency injection
     * or dynamic service updates during runtime.
     */
