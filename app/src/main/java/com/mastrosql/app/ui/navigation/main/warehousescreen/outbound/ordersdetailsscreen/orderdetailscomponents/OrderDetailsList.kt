...
@Composable
fun OrderDetailList(
    orderDetailList: List<com.mastrosql.app.ui.navigation.main.ordersscreen.ordersdetailsscreen.model.OrderDetailsItem>,
    ...
    )
    {
        ...
        val filteredList =
            orderDetailList//filterOrderDetailList(orderDetailList, searchTextState.value.text)
