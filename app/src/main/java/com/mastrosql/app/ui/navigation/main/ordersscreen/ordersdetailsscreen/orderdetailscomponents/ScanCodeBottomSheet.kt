...
@Composable
fun ScanCodeBottomSheetPreview() {
    ScanCodeBottomSheet(
        ...
        scannerState = ScannerState(
            scannedCode = remember { mutableStateOf("") },
            isTextInputFocused = remember { mutableStateOf(true) },
            isKeyboardVisible = remember { mutableStateOf(true) },
            isTextFieldPressed = remember { mutableStateOf(true) }
        ),
