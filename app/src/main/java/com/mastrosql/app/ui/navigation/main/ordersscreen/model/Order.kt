...
data class Order(
    ...
    @SerializedName("RAG_SOC") val businessName: String,
    ...
    @SerializedName("DESTINA_DESCRI") val destinationName: String,
    @SerializedName("DESCRI") val description: String,
    @SerializedName("N_LAV") val sequence: Int,
    ...
    @SerializedName("VETT_NUME") val carrierId: Int,
    @SerializedName("VETTORE") val carrierName: String,
    @SerializedName("PESO") val weight: Double,
    @SerializedName("NUME_ORDI") val port: String,
    @SerializedName("DATA_ORDI") val date: String,
    @SerializedName("NOTE") val notes: String,
    @SerializedName("D_CONSEGNA") val deliveryDate: String,
    @SerializedName("TASSATIVA") val deliveryDeadline: Boolean,
    @SerializedName("CONSEGNA") val deliveryType: Int,
    @SerializedName("STATO_CONS") val deliveryState: Int,
